...
namespace Restaurant.Helpers
{
    class ToWord
    {
        ...
        public ToWord(Decimal number, CurrencyInfo currency, String arabicPrefixText, String arabicSuffixText)
        {
            InitializeClass(number, currency, arabicPrefixText, arabicSuffixText);
        }
        ...
        /// <param name="arabicPrefixText">Arabic text to be placed before the generated text</param>
        /// <param name="arabicSuffixText">Arabic text to be placed after the generated text</param>
        private void InitializeClass(Decimal number, CurrencyInfo currency, String arabicPrefixText, String arabicSuffixText)
        {
            Number = number;
            Currency = currency;
